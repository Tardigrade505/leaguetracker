...
public class LeagueTrackerAPI {
    ...
    /**
     * The public API entrance for POSTs
     * @param path - the path of the POST
     * @param body - the body of the POST
     * @return a status code and body
     */
    public LeagueTrackerAPIResponse post(final String path, final String body) {
        return new LeagueTrackerAPIResponse(201, null);
    }

    /**
     * The public API entrance for GETs
     * @param path - the path of the GET
     * @return a status code and body
     */
    public LeagueTrackerAPIResponse get(final String path) {
        return routeGet(path);
    }

    private LeagueTrackerAPIResponse routeGet(final String path) {
        // GET all directories
//        if ("dirs/".equals(path)) {
//            return seasonController.getAllSeasonNames();
//        }

        return new LeagueTrackerAPIResponse(404, "Could not find endpoint for path: " + path);
    }
