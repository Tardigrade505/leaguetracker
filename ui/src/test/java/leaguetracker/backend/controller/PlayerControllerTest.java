...
import leaguetracker.backend.database.DatabaseTest;
import leaguetracker.backend.database.FileHandler;
import leaguetracker.backend.database.PlayerDatabase;
...
public class PlayerControllerTest extends DatabaseTest {
    private static final String TEST_BASE_PATH = BackendUtils.getProjectBasePath() + "ui/src/test/testDir/";
